...
A buck booster <a href="[such as this](https://www.amazon.com/dp/B0CWKWX7QC?ref=ppx_yo2ov_dt_b_fed_asin_title)" is used to boost voltage from the 3.3V pin on the MCU to 21V for the grid and segment pins.<br />
