...
<pre>
 ...
 E M N O C<br />
  ...
  <code>disp.on(int duration)</code>: all segments on, multiplexed across all grids for even power distribution.<br />
	...
	<code>disp.letter(int g, String whichLetter)</code>; Display a letter, a-z, in grid specified. All letters displayed as upper case. whichLetter arg is not a char because it is lowercased.<br />
